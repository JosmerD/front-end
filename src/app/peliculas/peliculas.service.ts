...
import { peliculaCreactionDTO, PeliculaPostGet,peliculaDTO,LandingPageDTO, PeliculaPutGet } from './pelicula';
...
export class PeliculasService {
  ...
  public crear(pelicula: peliculaCreactionDTO):Observable<number>{
  ...
  public editar(id:number,pelicula: peliculaCreactionDTO){
    const formData= this.ConstruirFormData(pelicula);
  ...
  private ConstruirFormData(pelicula:peliculaCreactionDTO):FormData{
